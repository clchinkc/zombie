...
# open the web browser to the google finance website
def get_stock_data(stock_name, start_date, end_date):
    # import web
    import webbrowser
    # open the web browser to the google finance website
    webbrowser.open('https://www.google.com/finance/quote/' + stock_name + ':NASDAQ')
    # import pandas
    import pandas as pd
    # import the data from google finance
    data = pd.read_csv('https://www.google.com/finance/historical?q=' + stock_name + ':NASDAQ&startdate=' + start_date + '&enddate=' + end_date + '&output=csv')
    # return the data
    return data

# get stock data from yahoo finance and save it to a csv file
def get_stock_data(stock_name, start_date, end_date):
    # open the web browser to the yahoo finance website
    webbrowser.open('https://finance.yahoo.com/')
    # get stock data from yahoo finance
    stock_data = webbrowser.DataReader(stock_name, 'yahoo', start_date, end_date)
...
def train_model():
    ...
    # get the quote
    apple_quote = webbrowser.DataReader('AAPL', data_source='yahoo', start='2012-01-01', end='2020-12-31')
